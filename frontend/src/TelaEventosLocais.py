...
from backend.src.entity.Evento import Evento
...
if __name__ == "__main__":
    ...
    eventos_exemplo = [
        Evento("Show de Rock Indie", "20:00", "Mineirão", 85.00, "path/to/foto1.jpg"),
        Evento("Palestra sobre IA Avançada", "14:30", "UFMG - Auditório Principal", 0.00, "path/to/foto1.jpg"),
        Evento("Feira de Artesanato Local", "09:00", "Praça da Liberdade", 15.00, "path/to/foto1.jpg"),
        Evento("Cinema ao Ar Livre com Pipoca", "19:00", "Parque das Mangabeiras", 30.00, "path/to/foto1.jpg"),
        Evento("Noite de Jazz", "21:00", "Café Central", 40.00, "path/to/foto1.jpg"),
        Evento("Workshop de Robótica", "10:00", "SENAI", 50.00, "path/to/foto1.jpg")
    ]
